...
import com.sapience.kiva.kivafinal.DeviceListFragment.ActivitySet;
import com.sapience.kiva.kivafinal.DeviceListFragment.DeviceActionListener;
import com.sapience.kiva.kivafinal.DeviceListFragment.InfoListener;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
            ...
            if (state == WifiP2pManager.WIFI_P2P_STATE_ENABLED) {
                ...
                //listener.setP2PStatus(true);
                //listener.resetViews();
            } else {
                //listener.setP2PStatus(false);

            }
            Log.d("Wifi", "P2P state changed - " + state);
